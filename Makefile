...
SEQUENCETOPROFILE_INCS = $(SIMULATIONSTUDY_INCS)

ALIGNEDFASTATOPROFILE_INCS = $(SIMULATIONSTUDY_INCS)

PROFILETREETOPROFILE_INCS = $(SIMULATIONSTUDY_INCS)
...
.PHONY: clean
clean:
	rm -f align score createRandomSequence drawSequences profileToSequence sequenceToProfile alignedFastaToProfile profileTreeToProfile $(ALIGN_OBJS) $(SCORE_OBJS) $(CREATERANDOMSEQUENCE_OBJS) $(DRAWSEQUENCES_OBJS) $(PROFILETOSEQUENCE_OBJS) $(SEQUENCETOPROFILE_OBJS) $(PROFILETREETOPROFILE_OBJS) $(ALIGNEDFASTATOPROFILE_OBJS)
